    ...
    style="border-top-right-radius: 85px; border-top-left-radius: 85px; position: relative;">
        ...
        <div class="logos">
            <div class="logos-slide">
                ...
                <img src="/layouts/m3.png" style="width: 275px; height: 290px;  " />
                <img src="/layouts/m4.png" style="width: 275px; height: 290px;  " />
        ...
        <div class="row" style="margin-top: 40px;">
            <div class="col-12" style="justify-content: center; align-items: center; display: flex;">
                <img src="/layouts/mpc.png" style="width: 868px; height: 642px;" />
            </div>
        </div>
